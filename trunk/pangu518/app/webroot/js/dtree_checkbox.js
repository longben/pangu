...
dTree.prototype.toString = function() {
	var str = '<div class="dtree"><form id="dTreeCheckBox">\n';
...
dTree.prototype.node = function(node, nodeId) {
	...
	if(this.config.useCheckBox && nodeId!=0){
		...
		str += '<input type="checkbox" name="id" id="c'+this.parEnum+'" onClick="caBox(\'c'+this.parEnum+'\')" value="' + ((node._ls) ? node.id : 'null') +'" class="cx"/>';
	}
	...
	Array.prototype.pop = function array_pop() {
		...
		function caBox( regx ) {
			if( document.getElementById( regx ).checked ){
				var form = document.getElementById("dTreeCheckBox");
