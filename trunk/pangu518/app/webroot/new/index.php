...
<?php	}else {?>		
	...
	<table border=0 cellpadding=0 cellspacing=0>
		<tr>
		  <td height=30>用户名:</td>
		  <td><input name="data[Member][username]" type="text" id="data[Member][username]" style="border:1px solid #999999;width:140px;height:19px;"></td>
		</tr>
		<tr>
		  <td height=30>密码:</td>
		  <td><input name="data[Member][password]" type="password" id="data[Member][password]" style="border:1px solid #999999;width:140px;height:19px;"></td>
		</tr>
		<tr>
		  <td height=30>验证码:</td>
		  <td align=left>
			<input type="text" style="border:1px solid #999999;width:80px;height:19px;" maxlength="4">
			&nbsp;<img src="safecode.php?r=<?=rand()?>" width=40 height=19 align="absbottom"><?=$_SESSION["osSafeCode"]?></td>
		</tr>
	</table>
...
<tr>
  ...
  <tr>
	...
	<tr>
	  ...
	  <td align=right style="padding-right:10px"><a href="workstations.php"><img src="images/more.jpg" border="0"></a></td>
	</tr>
	</table>
	</td>
  </tr>
  ...
  <tr>
    <td align=center><a href="workstations.php"><img src="images/test02.jpg" border="0"></a> </td>
  </tr>
  <tr>
