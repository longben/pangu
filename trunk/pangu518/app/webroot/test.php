					...
					<tr>
						<td align="center" valign="top" width="663">　
						  <table width="691" cellpadding="0" cellspacing="0" id="table4">
							<!-- MSTableType="layout" -->
							<tr>
							<form name="form_pg" method=post action="testregister.php" onSubmit="return check()">
								...
								<table cellpadding="3" cellspacing="1" bgcolor="#C0C0C0" id="table5" width="675">
									...
									<tr>
									  <td height="35" colspan="2" align="center" valign="middle" bgcolor="#FFFFFF"><span class="STYLE10">提 款 申 请</span><br>
									    <span class="style3">*注意：提现申请后，公司会给你做相应的处理，处理时间一般会在一周之内，我们会在一周之内给你回复！<br>每笔成功提现后，公司扣除20%公司管理费用。</span></td>
								    </tr>
								  ...
								  <tr>
									  ...
									  <td width="512" align="left" valign="middle" bgcolor="#FFFFFF"><input name="timoney" type="text" id="timoney" size="20"></td>
								  </tr>
								  <tr>
