...
?>
  ...
  <?php	
		...
		if($i == 1){
  ?>
    <td rowspan="<?=date('t')?>" align="center" class="title"><?=$reportMonth?>月</td>
  <?php	}?>
	...
	<!-- 显示会员总数数据 -->
	<?php
		$sql_member_total = " select count(*) from users where substring(created,1,4) = '$reportYear' and substring(created,6,2) = '$reportMonth' and substring(created,9,2) = $i";	
	...
	<?php
		...
		while($arr_member_sheng= mysql_fetch_array($stmt_member_sheng)){
			...
			$sql_member_count = "select count(*) from users where region_id = ".$arr_member_sheng[0]." and substring(created,1,4) = '$reportYear' and substring(created,6,2) = '$reportMonth' and substring(created,9,2) = $i";
	...
	<?php
		$sql_merchant_total = " select count(*) from merchants where substring(created,1,4) = '$reportYear' and substring(created,6,2) = '$reportMonth' and substring(created,9,2) = $i";	
		...
		$sql_merchant_total_1 = " select count(*) from merchants where substring(created,1,4) = '$reportYear' and substring(created,6,2) = '$reportMonth' and substring(created,9,2) = $i and status = 1";	
		...
		$sql_merchant_total_9 = " select count(*) from merchants where substring(created,1,4) = '$reportYear' and substring(created,6,2) = '$reportMonth' and substring(created,9,2) = $i and status = 9";	
	...
	<?php
		...
		while($arr_merchant_sheng= mysql_fetch_array($stmt_merchant_sheng)){
			...
			$sql_merchant_count = "select count(*) from merchants where region_id = ".$arr_merchant_sheng[0]." and  substring(created,1,4) = '$reportYear' and substring(created,6,2) = '$reportMonth' and substring(created,9,2) = $i";
	...
	<?php
		$sql_workstation_total = " select count(*) from workstations where substring(created,1,4) = '$reportYear' and substring(created,6,2) = '$reportMonth' and substring(created,9,2) = $i";	
		...
		$sql_workstation_total_1 = " select count(*) from workstations where substring(created,1,4) = '$reportYear' and substring(created,6,2) = '$reportMonth' and substring(created,9,2) = $i and status = 1";	
		...
		$sql_workstation_total_9 = " select count(*) from workstations where substring(created,1,4) = '$reportYear' and substring(created,6,2) = '$reportMonth' and substring(created,9,2) = $i and status = 9";	
	...
	<?php
		...
		while($arr_workstation_sheng= mysql_fetch_array($stmt_workstation_sheng)){
			...
			$sql_workstation_count = "select count(*) from workstations where region_id = ".$arr_workstation_sheng[0]." and substring(created,1,4) = '$reportYear' and substring(created,6,2) = '$reportMonth' and substring(created,9,2) = $i";
