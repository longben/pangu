...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#888888">
  <tr>
    ...
    <td colspan="3"  align="center" bgcolor="#CCFFCC"><span class="STYLE9">拒绝时间</span></td>
  </tr>
  <?php 
	 $sql=mysql_query("select cotmoney.*,users.user_name from cotmoney inner join users on cotmoney.ctnid=users.id where cotmoney.flag='2'");
  ...
  <tr>
    ...
    <!--<td width="140"  align="center" bgcolor="#CCFFCC"><span class="STYLE2">支付时间<?php echo $result[crto]?></span></td>
    <td width="140"  align="center" bgcolor="#CCFFCC"><span class="STYLE2">拒绝时间<?php echo $result[crto]?></span></td>-->

    <td width="140"  align="center" bgcolor="#CCFFCC"><?php echo $result[crto]?></td>
