...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#888888">
  <tr>
    ...
    <td colspan="3"  align="center" bgcolor="#CCFFCC"><span class="STYLE9">支付时间</span></td>
  </tr>
  <?php 
	 $sql=mysql_query("select cotmoney.*,users.user_name from cotmoney inner join users on cotmoney.ctnid=users.id where cotmoney.flag='1'");
