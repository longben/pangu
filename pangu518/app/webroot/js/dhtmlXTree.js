 ...
 else
{
 ...
 dhtmlXTreeObject.prototype.setOnClickHandler=function(testA){if(typeof(func)=="function")this.aFunc=func;else this.aFunc=eval(func);};

 dhtmlXTreeObject.prototype.testA=function(func){alert("test")};
